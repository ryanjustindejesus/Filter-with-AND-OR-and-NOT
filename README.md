...
In this task, my team is investigating failed login attempts that were made after business hours. I retrieved this information from the login activity. I will be identifying all unsuccessful attempts after 18:00.
<br/> <br />
...
In this task, my team is investigating a suspicious event that occurred on '2022-05-09'. I retrieved all login attempts that occurred on this day and the day before ('2022-05-08').
<br/> <br />
(1) I used the command "SELECT * FROM log_in_attempts WHERE login_date = '2022-05-09' OR login_date = '2022-05-08';" to retrieve the failed login attempts on the specified days.
<br /> <br /> <p align="center">
...
In this task, my team is investigating logins that did not originate in Mexico, and I found this information.
 <br/> <br/>
(1) I used the command "SELECT * FROM log_in_attempts WHERE NOT country LIKE 'MEX%';" to retrieve login attempts that did not originate in Mexico.
<br/> <br/> <p align="center">
...
In this task, my team is updating employee machines.
 <br/> <br/> 
(1) I used the command "SELECT * FROM employees WHERE department = 'Marketing' AND office LIKE 'East%';" to retrieve information about employees in the 'Marketing' department who are located in all offices in the East building (such as 'East-170' or 'East-320').
<br/> <br/>  <p align="center">
<img src="https://imgur.com/V6j2JpV.png" height="80%" width="80%" alt="Disk Sanitization Steps"/> 
<br /> <br />

<h2>Task 5: Description </h2>
In this task, my team needs to perform a different update to the computers of all employees in the Finance or the Sales department, and I located information on these employees.
 <br/> <br/> 
(1) I used the command "SELECT * FROM employees WHERE department = 'Finance' OR department = 'Sales';" to retrieve records for employees in the 'Finance' or the 'Sales' department.
<br/> <br/>  <p align="center">
...
In this task, my team needs to make one more update. This update was already made to employee computers in the Information Technology department. The team needs information about employees who are not in that department. 
 <br/> <br/> 
(1) I used the command "SELECT *FROM employees WHERE NOT department = 'Information Technology';" to retrieve records for employees who are not in the 'Information Technology' department.
<br/> <br/>  <p align="center">
